 ...
 *
 * Secant Healthcare. - Copyright 2010
 *
...
public class AetDAOImpl extends SqlMapClientDaoSupport implements AetDAO {

    public AET getAETByModule(String module) throws DataAccessException {
        return (AET) getSqlMapClientTemplate().queryForObject("getAETByModule", module);
    }
}
